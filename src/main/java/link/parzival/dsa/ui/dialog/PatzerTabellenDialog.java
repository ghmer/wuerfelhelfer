...
public class PatzerTabellenDialog extends JDialog {
	...
	public static final String[] patzerBeschreibungen = {
	...
	public static void main(String[] args) {
		try {
			PatzerTabellenDialog dialog = new PatzerTabellenDialog();
	...
	public PatzerTabellenDialog() {
		...
		}
		{
			...
			String[][] tableRows = new String[6][2];
			tableRows[0] = new String[] {	"2", 
											"Waffe zerstört"
										};
			tableRows[1] = new String[] {
											"3-5",
											"Sturz"
										};
			tableRows[2] = new String[] {
											"6-8",
											"Stolpern"
										};
			tableRows[3] = new String[] {
											"9-10",
											"Waffe verloren"
										};
			tableRows[4] = new String[] {
											"11",
											"An eigener Waffe verletzt"
										};
			tableRows[5] = new String[] {
											"12",
			...
			table.addMouseListener(new MouseAdapter() {
			    public void mousePressed(MouseEvent mouseEvent) {
			        ...
			        if (mouseEvent.getClickCount() == 2 && table.getSelectedRow() != -1) {
			        	if(row >= 0 && row <= patzerBeschreibungen.length) {
			        		String patzerBeschreibung = patzerBeschreibungen[row];
			        		PatzerBeschreibungDialog patzerBeschreibungDialog = new PatzerBeschreibungDialog(patzerBeschreibung);
